...
from cloudtree import UsageError

from cloudtree.cmds.CTCommand import CTCommand
from cloudtree.cmds.InitCmd import InitCmd
...
if __name__ == '__main__':
    ...
    # Usage error
        ...
        print("")
        select_command(('help', )).execute((cmd.name, ))
        sys.exit(1)
